#!/usr/bin/env python3
"""Seed v0.3 MVP closure/release audit-derived tasks as ready queue items."""
...
TASK_SPECS = [
    {
        "lifecycle_key": "audit/v0.3/release/baseline-checklist",
        "description": "Run manual mvp-v03.md baseline and document pass/fail/blocked items.",
        "priority": "high",
        "effort": "low",
        "risk": "low",
        "task_type": "doc",
    ...
    {
        "lifecycle_key": "audit/v0.3/release/full-test-suite",
        "description": "Run full unittest suite (including web extra); fix regressions until green.",
        "priority": "critical",
        "effort": "high",
        "risk": "medium",
        "task_type": "ops",
    ...
    {
        "lifecycle_key": "audit/v0.3/release/installer-alignment",
        "description": "Align capinstall install/update/verify: pyproject data-files skills, integration_config, tests/install.",
        "priority": "critical",
        "effort": "medium",
        "risk": "medium",
        "task_type": "ops",
    ...
    {
        "lifecycle_key": "audit/v0.3/release/readme-alignment",
        "description": "Update README.md for v0.3 hub: mvp-v03 checklist, install path, skills, capiforge web.",
        "priority": "high",
        "effort": "medium",
        "risk": "low",
        "task_type": "doc",
    ...
    {
        "lifecycle_key": "audit/v0.3/release/version-bump",
        "description": "Bump version to 0.3.0 in pyproject.toml and debian/changelog; capiforge --version coherent.",
        "priority": "high",
        "effort": "low",
        "risk": "low",
        "task_type": "ops",
    ...
    {
        "lifecycle_key": "audit/v0.3/release/fresh-install-smoke",
        "description": "Smoke test README path: capinstall install, verify, update, capiforge web.",
        "priority": "high",
        "effort": "medium",
        "risk": "medium",
        "task_type": "ops",
    ...
    {
        "lifecycle_key": "audit/v0.3/release/demo-script",
        "description": "Write 5-minute human demo script for v0.3 hub (web, docs, tasks, realtime).",
        "priority": "medium",
        "effort": "low",
        "risk": "low",
        "task_type": "doc",
    ...
    {
        "lifecycle_key": "audit/v0.3/release/regression-gate",
        "description": "Re-run full test suite and mvp-v03 checklist after agent queue drains.",
        "priority": "critical",
        "effort": "medium",
        "risk": "medium",
        "task_type": "ops",
    ...
    {
        "lifecycle_key": "audit/v0.3/release/git-tag-v030",
        "description": "Create annotated git tag v0.3.0 after release gate is green (with owner approval).",
        "priority": "high",
        "effort": "low",
        "risk": "low",
        "task_type": "ops",
...
def _build_actor(store: NodeStore, *, node_id: str) -> ActorIdentity:
    ...
    session_id = "seed-audit-v03-closure"
...
def seed_tasks(*, repo_root: Path, audit_id: str, dry_run: bool = False) -> list[dict]:
    ...
    created: list[dict] = []
    with bootstrap.bootstrap_session(command="seed_audit_v03_closure", timeout=30.0, interactive=False):
        ...
        try:
            ...
            for spec in TASK_SPECS:
                ...
                justification = JustificationPayload(
                    ...
                    expected_impact="Close MVP v0.3 release gate.",
                )
                execution_context = {
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Seed v0.3 closure audit-derived ready tasks.")
