#!/usr/bin/env python3
"""Seed v0.4 web-visualization audit-derived tasks as ready queue items."""
...
TASK_SPECS = [
    {
        "lifecycle_key": "audit/v0.4/web/task-detail-data",
        "description": "Mejorar visualización de datos en el panel de detalle de tareas (campos estructurados, metadatos, acciones en español).",
        "priority": "high",
        "effort": "medium",
        "risk": "low",
        "task_type": "feature",
    ...
    {
        "lifecycle_key": "audit/v0.4/web/home-dashboard",
        "description": "Reorganizar la página de inicio: resumen del proyecto, cola y contexto legible sin IDs crudos.",
        "priority": "high",
        "effort": "medium",
        "risk": "low",
        "task_type": "feature",
    ...
    {
        "lifecycle_key": "audit/v0.4/web/spanish-content",
        "description": "Política de contenido en español: UI restante, etiquetas, mensajes y guía para auditorías/tareas nuevas.",
        "priority": "medium",
        "effort": "medium",
        "risk": "low",
        "task_type": "doc",
...
def seed_tasks(*, repo_root: Path, audit_id: str, dry_run: bool = False) -> list[dict]:
    ...
    created: list[dict] = []
    with bootstrap.bootstrap_session(command="seed_audit_v04_web", timeout=30.0, interactive=False):
        ...
        try:
            ...
            for spec in TASK_SPECS:
                ...
                justification = JustificationPayload(
                    summary=f"Derivado de auditoría {audit_id}: {spec['description']}",
                    evidence_refs=(f"audit://{audit_id}", f"lifecycle://{lifecycle_key}"),
                    expected_impact="Mejorar lectura de datos en la web de CapiForge v0.4.",
                )
                execution_context = {
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Seed v0.4 web-visualization audit-derived ready tasks.")
